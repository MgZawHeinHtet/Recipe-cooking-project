<template>
    <div class="card px-7 space-y-5">
        ...
        <div class="card_content space-y-4">
            <div>
                <h4 class="text-center mb-2 text-slate-800 text-xl font-bold capitalize">spaghetti</h4>
                <!-- star rating  -->
            ...
            <p class="text-center text-slate-600 text-base">Pasta is a type of food typically made from an
                unfavoured dough.</p>
            <div class="flex justify-center items-center space-x-5">
                <span class="text-xl font-bold">$400</span>
                <button class="w-32 py-2 border rounded-3xl border-green-500 text-sm font-bold hover:ring-2 ring-green-500 transition-all duration-75">Add To Cart</button>
            </div>
